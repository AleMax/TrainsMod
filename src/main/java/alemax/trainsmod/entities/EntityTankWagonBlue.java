...
public class EntityTankWagonBlue extends EntityRailcar {

	public EntityTankWagonBlue(World worldIn) {
		super(worldIn);
		setup();
	}


	public EntityTankWagonBlue(World worldIn, BlockPos placedOn) {
