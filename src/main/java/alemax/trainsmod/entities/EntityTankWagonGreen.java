...
public class EntityTankWagonGreen extends EntityRailcar {

	public EntityTankWagonGreen(World worldIn) {
		super(worldIn);
		setup();
	}


	public EntityTankWagonGreen(World worldIn, BlockPos placedOn) {
