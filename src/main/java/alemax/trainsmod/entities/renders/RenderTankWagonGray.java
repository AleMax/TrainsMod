...
public class RenderTankWagonGray extends Render<EntityTankWagonGray> {

	private static final ResourceLocation TEXTURE = new ResourceLocation(Reference.MODID, "textures/entities/tank_wagon_gray.png");
	ModelRailcar model = new ModelRailcar("tank_wagon_gray.obj");
	
    public static final Factory FACTORY = new Factory();
	
	public RenderTankWagonGray(RenderManager rendermanagerIn) {
		super(rendermanagerIn);	
		
	}
		
	public void doRender(EntityTankWagonGray entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
	...
	@Override
	protected ResourceLocation getEntityTexture(EntityTankWagonGray entity) {
		return this.TEXTURE;
	}
	
	
	public static class Factory implements IRenderFactory<EntityTankWagonGray> {

		@Override
		public Render<? super EntityTankWagonGray> createRenderFor(RenderManager manager) {
			return new RenderTankWagonGray(manager);
		}
