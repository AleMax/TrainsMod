...
public class RenderSNexasRailcar extends Render<EntitySNexasRailcar> {

	private static final ResourceLocation TEXTURE = new ResourceLocation(Reference.MODID, "textures/entities/s_nexas_railcar.png");
	ModelRailcar model = new ModelRailcar("s_nexas_railcar.obj");
	
    public static final Factory FACTORY = new Factory();
	
	public RenderSNexasRailcar(RenderManager rendermanagerIn) {
		super(rendermanagerIn);	
		
	}
		
	public void doRender(EntitySNexasRailcar entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
	...
	@Override
	protected ResourceLocation getEntityTexture(EntitySNexasRailcar entity) {
		return this.TEXTURE;
	}
	
	
	public static class Factory implements IRenderFactory<EntitySNexasRailcar> {

		@Override
		public Render<? super EntitySNexasRailcar> createRenderFor(RenderManager manager) {
			return new RenderSNexasRailcar(manager);
		}
