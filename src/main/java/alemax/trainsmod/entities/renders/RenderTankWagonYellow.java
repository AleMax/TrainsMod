...
public class RenderTankWagonYellow extends Render<EntityTankWagonYellow> {

	private static final ResourceLocation TEXTURE = new ResourceLocation(Reference.MODID, "textures/entities/tank_wagon_yellow.png");
	ModelRailcar model = new ModelRailcar("tank_wagon_yellow.obj");
	
    public static final Factory FACTORY = new Factory();
	
	public RenderTankWagonYellow(RenderManager rendermanagerIn) {
		super(rendermanagerIn);	
		
	}
		
	public void doRender(EntityTankWagonYellow entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
	...
	@Override
	protected ResourceLocation getEntityTexture(EntityTankWagonYellow entity) {
		return this.TEXTURE;
	}
	
	
	public static class Factory implements IRenderFactory<EntityTankWagonYellow> {

		@Override
		public Render<? super EntityTankWagonYellow> createRenderFor(RenderManager manager) {
			return new RenderTankWagonYellow(manager);
		}
