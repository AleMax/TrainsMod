...
public class EntityTankWagonYellow extends EntityRailcar {

	public EntityTankWagonYellow(World worldIn) {
		super(worldIn);
		setup();
	}


	public EntityTankWagonYellow(World worldIn, BlockPos placedOn) {
