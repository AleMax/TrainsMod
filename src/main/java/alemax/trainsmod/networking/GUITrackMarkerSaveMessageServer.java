...
public class GUITrackMarkerSaveMessageServer implements IMessage {
	...
	public GUITrackMarkerSaveMessageServer() {}
	
    public GUITrackMarkerSaveMessageServer(String channel, float angle, byte height, TrackType trackType, int posX, int posY, int posZ) {
	...
	public static class GUITrackMarkerSaveMessageServerHandler implements IMessageHandler<GUITrackMarkerSaveMessageServer, IMessage> {

		@Override
		public IMessage onMessage(GUITrackMarkerSaveMessageServer message, MessageContext ctx) {
			try {
