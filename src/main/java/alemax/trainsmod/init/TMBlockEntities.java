...
public class TMBlockEntities {
    ...
    public static void registerAll() {
        BLOCK_ENTITY_TRACK_MARKER = Registry.register(Registry.BLOCK_ENTITY, TrainsMod.modid + ":" + "track_marker", BlockEntityType.Builder.create(BlockEntityTrackMarker::new, TMBlocks.BLOCK_TRACK_MARKER).build(null));
    }
